<div class="main p-3">
    <div class="text-center">
        <section class="container my-2 bg-secondary w-50 text-light p-2">
            <h6 style="text-align: center; text-transform: uppercase; font-weight: bold;">Thêm công việc</h6>
            <form class="row g-3 p-3" method="POST" action="index.php?quanly=xulythemcongviec"
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputState" class="form-select" name="tennv">
                        ...
                        ?>
                        <option value="<?php echo $row_tieuchi['id_nhanvien'] ?>"><?php echo $row_tieuchi['tennv'] ?>
                        </option>
                        <?php
                            }
                        ?>
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" name="themcongviec">Thêm công việc</button>
                </div>
            </form>
        </section>
    </div>
